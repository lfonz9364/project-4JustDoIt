...
car2 = Car.create(user_id: 2, seat_number: 2, meeting_point: '45 William Street', suburb: 'Melbourne', smoker_friendly: true, date:'10-May-2017', time: '08:00', description: 'I have seats avaialable');

comment1 = Comment.create(body: 'lovely person', car_id: 1, passenger_id: 3);
comment2 = Comment.create(body: 'pleasant ride', car_id: 1, passenger_id: 4);
comment3 = Comment.create(body: 'definitely will ride with this person again ', car_id: 2, passenger_id: 5);
comment4 = Comment.create(body: 'clean car', car_id: 2, passenger_id: 6);
