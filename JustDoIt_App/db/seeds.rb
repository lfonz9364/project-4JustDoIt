...
car1 = Car.create(user_id: 1, seat_number: 3, meeting_point: '6 Roger Court', suburb: 'Rowville', smoker_friendly: false, date_time: 'Mon, 09 Oct 2017 16:30:00 UTC +00:00', description: 'I have seats avaialable');
car2 = Car.create(user_id: 2, seat_number: 2, meeting_point: '45 William Street', suburb: 'Melbourne', smoker_friendly: true, date_time:'Tue, 11 Oct 2017 19:30:00 UTC +00:00', description: 'I have seats avaialable');
